    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="问题名称" prop="yonghuwentiName">
                       <el-input v-model="ruleForm.yonghuwentiName"
                                 placeholder="问题名称" clearable  :readonly="ro.yonghuwentiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="问题名称" prop="yonghuwentiName">
                           <el-input v-model="ruleForm.yonghuwentiName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="用户问题类型" prop="yonghuwentiTypes">
                        <el-select v-model="ruleForm.yonghuwentiTypes" :disabled="ro.yonghuwentiTypes" placeholder="请选择用户问题类型">
                            <el-option
                                v-for="(item,index) in yonghuwentiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="用户问题类型" prop="yonghuwentiValue">
                        <el-input v-model="ruleForm.yonghuwentiValue"
                            placeholder="用户问题类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="用户问题详情" prop="yonghuwentiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yonghuwentiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghuwentiContent" label="用户问题详情" prop="yonghuwentiContent">
                            <span v-html="ruleForm.yonghuwentiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="sessionTable !='yonghu'">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    yonghuwentiName: false,
                    yonghuwentiTypes: false,
                    yonghuwentiContent: false,
                    insertTime: false,
                    huifuContent: false,
                },
                ruleForm: {
                ...
                rules: {
                   ...
                   yonghuwentiTypes: [
                              { required: true, message: '用户问题类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   yonghuwentiContent: [
                              { required: true, message: '用户问题详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghuwenti_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yonghuwentiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yonghuwenti/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yonghuwentiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
