        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="风险等级" prop="diquTypes">
                        <el-select v-model="ruleForm.diquTypes" :disabled="ro.diquTypes" placeholder="请选择风险等级">
                            <el-option
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="地区详情" prop="diquContent">
